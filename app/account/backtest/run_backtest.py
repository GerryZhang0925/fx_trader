"""CLI: python -m account.backtest.run_backtest --strategy donchian --synthetic"""
...
from strategy.catalog import STRATEGIES, build_strategy  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    with tracked("account", "backtest", out_dir=out_dir, message=args.strategy):
