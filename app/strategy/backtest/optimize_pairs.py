...
from strategy.backtest.optimize_donchian import TRAIN_END, TEST_END, _row, grid_params  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    (out_dir / "all_pairs.json").write_text(json.dumps(catalog, indent=2, default=str), encoding="utf-8")
    print(f"Wrote {out_dir / 'all_pairs.json'}")
    return 0
